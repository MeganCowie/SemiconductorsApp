...
Vg_array = np.arange(2500)/500-2 #eV
#Vg_array = np.arange(5000)/50000-1.8 #eV

zins_array = (np.arange(2000)/200+0.05)*1e-7 #cm
sampletype = False
...
fig.update_yaxes(title_text= "Vs", row=1, col=2)
fig.update_yaxes(title_text= "F", row=2, col=2)
