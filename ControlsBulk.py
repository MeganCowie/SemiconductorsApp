...
Distributions = dbc.Card([
        dbc.Row([
            ...
            dbc.Col(html.Div(id='DistributionsText_Ef', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div(id='DistributionsText_T', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
            dbc.Col(dcc.Slider(id='DistributionsSlider_T', marks=None, min=0, max=1000, step=1, value=300,), style={"marginBottom":"-20px"}, md=12),
        ]),
], body=True,)
...
CarrierIntegrals = dbc.Card([
        dbc.Row([
            ...
            dbc.Col(html.Div(id='CarrierIntegralsText_Ef', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div(id='CarrierIntegralsText_T', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div(id='CarrierIntegralsText_gc', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div(id='CarrierIntegralsText_gv', style = {'textAlign': 'right'}), md=4),
        ], justify="between"),
        dbc.Row([
            dbc.Col(dcc.Slider(id='CarrierIntegralsSlider_gv', marks=None, min=0, max=5, step=0.1, value=2,), style={"marginBottom":"-20px"}, md=12),
        ]),
], body=True,)
...
Bulk_Card = dbc.Card([
    ...
    dbc.Row([
    dbc.Row([
        dbc.Col(dbc.Label("Donors (cm-3)", id="BulkText_donorlabel", style = {'textAlign': 'right', "marginLeft": "10px","marginTop": "20px"}), md=8),
        dbc.Col(html.Div(id='BulkText_donor',style={'textAlign': 'right', "marginLeft": "-10px", "marginRight": "10px","marginTop": "20px"}), md=4),
    ], justify="between"),
    dbc.Row([
        dbc.Col(dcc.Slider(id='BulkSlider_donor', marks=None, min=25, max=35, step=0.1, value=0, disabled=True)),
    ]),
    dbc.Row([
        dbc.Col(dbc.Label("Acceptors (cm-3)", id="BulkText_acceptorlabel", style = {'textAlign': 'right', "marginLeft": "10px"}), md=8),
        dbc.Col(html.Div(id='BulkText_acceptor',style={'textAlign': 'right', "marginLeft": "-10px", "marginRight": "10px"}), md=4),
    ], justify="between"),
    dbc.Row([
    ...
    dbc.Row([
        dbc.Col([
                dbc.Row([
                    dbc.Col(dbc.Label("Elec. Eff. Mass (me)", id="BulkText_emasslabel", style={'fontSize': 10, "marginLeft": "10px", "marginRight": "-10px"}), md=8),
                    dbc.Col(html.Div(id='BulkText_emass',style={'fontSize': 10, 'textAlign': 'right'}), md=4),
                ], justify="between"),
                dbc.Row([
        ...
        dbc.Col([
                dbc.Row([
                    ...
                    dbc.Col(html.Div(id='BulkText_hmass',style={'fontSize': 12, 'textAlign': 'right', "marginRight": "10px"}), md=4),
                ], justify="between"),
                dbc.Row([
    ...
    dbc.Row([
        dbc.Col(dbc.Label("Temperature (K)", id="BulkText_Tlabel", style = {'textAlign': 'right', "marginLeft": "10px"}), md=8),
        dbc.Col(html.Div(id='BulkText_T', style = {'textAlign': 'right', "marginRight": "10px"}), md=4),
    ], justify="between"),
    dbc.Row([
        dbc.Col(dcc.Slider(id='BulkSlider_T', marks=None, min=100, max=1000, step=1, value=300,), style={"marginBottom":"-10px"}, md=12),
    ]),
    ]),
]),
