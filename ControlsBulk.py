...
Distributions = dbc.Card([
    dbc.FormGroup([
        ...
        dbc.Row([
            dbc.Col(dcc.Slider(id='DistributionsSlider_T', min=0, max=1000, step=1, value=300,), style={"margin-bottom":"-20px"}, md=12),
        ]),
    ]),
], body=True,)
...
CarrierIntegrals = dbc.Card([
    dbc.FormGroup([
        ...
        dbc.Row([
            dbc.Col(dcc.Slider(id='CarrierIntegralsSlider_gv', min=0, max=5, step=0.1, value=2,), style={"margin-bottom":"-20px"}, md=12),
        ]),
    ]),
], body=True,)
...
Bulk_Card = dbc.Card([
    ...
    dbc.Row([
        dbc.Col(dcc.Slider(id='BulkSlider_donor', min=17, max=20, step=0.1, value=0, disabled=True)),
    ]),
    dbc.Row([
    ...
    dbc.Row([
        dbc.Col(dcc.Slider(id='BulkSlider_acceptor', min=17, max=20, step=0.1, value=0)),
    ]),
    dbc.Row([
        dbc.Col([
            dbc.FormGroup([
                ...
                dbc.Row([
                    dbc.Col(dcc.Slider(id='BulkSlider_emass', min=0.1, max=2, step=0.1, value=1.0,)),
                ]),
            ]),
        ], md=6),
        dbc.Col([
            dbc.FormGroup([
                ...
                dbc.Row([
                    dbc.Col(dcc.Slider(id='BulkSlider_hmass', min=0.1, max=2, step=0.1, value=1.0,), md=12),
                ]),
            ]),
        ], md=6)
    ...
    dbc.Row([
        dbc.Col(dcc.Slider(id='BulkSlider_T', min=100, max=1000, step=1, value=300,), style={"margin-bottom":"-10px"}, md=12),
    ]),
    ]),
]),
